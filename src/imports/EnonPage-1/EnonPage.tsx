...
import imgEnonLandingCover1 from "./67348ba3db652d0306491cd03fdb4c53082e75f8.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">ENON (Landing page)</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="flex flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[22px] text-left text-white w-full">
            <p>
              <span className="leading-[normal]">
                This is the coded structure responsive.
                <br aria-hidden="true" />
              </span>
              <span className="font-['Kaisei_Decol:Regular',sans-serif] leading-[normal] not-italic">{`ENON is an accounting and inventory management browser based for businesses. `}</span>
            </p>
          </div>
        </div>
      </div>
...
export default function EnonPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="ENON page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
