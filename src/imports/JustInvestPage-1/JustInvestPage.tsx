import imgJustInvestCover1 from "./415bfe6db5f035639333255fa19c810542ba235d.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">Just Invest (Landing page)</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="bg-white content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="just invest cover 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgJustInvestCover1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Intro">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col font-['Kaisei_Decol:Regular',sans-serif] gap-[20px] items-start leading-[0] not-italic p-[2px] relative size-full text-left text-white">
          <div className="flex flex-col justify-center relative shrink-0 text-[22px] w-full">
          ...
          <div className="flex flex-col justify-center relative shrink-0 text-[16px] w-full">
            <p className="leading-[normal]">* Just Invest is the old name of Just Fin due to the financial services law of Thailand, The company will change it later.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">
              <p className="leading-[normal]">Go to the site</p>
            </div>
          </div>
        </div>
...
export default function JustInvestPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="Just invest page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
