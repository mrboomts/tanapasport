...
import imgChocbanaPresent1 from "./3886b8406b0199ba6fd7d19f2fce4bf739c43683.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">ChocBana</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="chocbana present 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgChocbanaPresent1} />
      </div>
    </div>
  );
}
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[22px] text-left text-white">
            <p className="leading-[normal]">ChocBana is a colorful shopping app that follows vertical media trends. Make your online store easier to work with without having to crop the size of your images and videos. And the buyers can share the product’s experience by chatting.</p>
          </div>
        </div>
      </div>
    </div>
...
export default function ChocBanaPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="ChocBana page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
