import svgPaths from "./svg-x7ob7sbalc";
  ...
  return (
    <div className="relative shrink-0 size-[80px]" data-name="ci:menu-alt-05">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g id="ci:menu-alt-05">
          <path d={svgPaths.p1666cb00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame1() {
  return (
    <div className="bg-[#946e52] h-px mb-[-1px] relative rounded-bl-[20px] rounded-br-[20px] shrink-0 w-[1440px]">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center pb-[10px] pt-[30px] px-[100px] relative size-full">
          <Frame2 />
        </div>
      </div>
    </div>
