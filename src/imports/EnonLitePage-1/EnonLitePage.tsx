...
import imgEnonLandingCover1 from "./b04eb831ce95872b41d195bb0be2ce203d1894f4.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">ENON Lite</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="ENON Landing cover 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgEnonLandingCover1} />
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Intro">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start p-[2px] relative size-full">
          <div className="flex flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[22px] text-left text-white w-full whitespace-pre-wrap">
            <p className="leading-[normal] mb-0">For selling to SME businesses, the ENON Lite version (browser based is a small version of ENON that</p>
            <p className="leading-[normal]">
              {`remove some functions from the full version that are not necessary to SMEs and has a more `}
              <br aria-hidden="true" />
          ...
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap" role="link" tabIndex="0">
              <p className="cursor-pointer">
                <span className="leading-[normal]">View prototyp</span>
...
export default function EnonLitePage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="ENON lite page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
