import imgCoverService1 from "./c76c13915578059468dc69dd30fbc96dfbb479b7.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">Just Service</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="bg-white content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="cover service 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCoverService1} />
      </div>
    </div>
  );
}
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[20px] items-start p-[2px] relative size-full">
          <div className="flex flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[22px] text-left text-white w-full">
            <p className="leading-[normal]">Just Service is an app specific for riders or mechanics to provide car services like tire changes, petrol refills, and more, operating under the Just Car brand.</p>
          </div>
          <Frame5 />
        </div>
      </div>
...
export default function JustServicePage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="Just Service page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
