...
import imgPresentMobilePia1 from "./e964c1b8942b6ea5974a1466b47fceb6364812df.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">PIA [Pay It All]</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="present-mobile-pia 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPresentMobilePia1} />
      </div>
    </div>
  );
}
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[22px] text-left text-white">
            <p className="leading-[normal]">PIA (Pay It All) is a financial app where you can pay all the subscriptions and bills in alternative currencies in one app.</p>
          </div>
        </div>
      </div>
    </div>
...
export default function PiaPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="PIA page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
