...
import imgPresentAnidrugs1 from "./84213c8a1a7f7540399bdd805b3362bf7341b824.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">AniDrugs</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Present anidrugs 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPresentAnidrugs1} />
      </div>
    </div>
  );
}
...
function Intro2() {
  return (
    <div className="h-[324px] relative shrink-0 w-full" data-name="Intro">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-between leading-[0] p-[2px] relative size-full text-[22px] text-left text-white">
          <div className="flex flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center not-italic relative shrink-0 w-full">
            <p className="leading-[normal]">AniDrugs is an app about drugs for the livestock (animals for agriculture) market. This app has a mini social network that allows veterinarians, livestock farmers, and sellers of drugs for livestock to share their knowledge.</p>
          </div>
          <div className="flex flex-col font-['Kaisei_Decol:Regular','Noto_Sans_Thai:Regular',sans-serif] justify-center relative shrink-0 w-full" style={{ fontVariationSettings: "'wdth' 100, 'wght' 400" }}>
            <p className="leading-[normal]">*ภาษาไทย</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch cursor-pointer flex gap-[10px] items-center relative shrink-0 w-full">
        ...
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">
              <p className="leading-[normal]">View prototype</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[10px]" role="link" tabIndex="0" data-name="Button">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#946e52] text-[18px] text-center whitespace-nowrap">
              <p className="leading-[normal]">View Figma file</p>
            </div>
          </div>
        </div>
        <div aria-hidden="true" className="absolute border border-[#946e52] border-solid inset-[-0.5px] pointer-events-none rounded-[10.5px]" />
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[50px] items-start min-w-px relative">
      <Intro2 />
      <Frame3 />
    </div>
  );
...
export default function AniDrugsPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="AniDrugs page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
