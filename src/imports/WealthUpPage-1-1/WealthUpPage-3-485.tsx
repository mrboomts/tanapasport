...
import imgCover1 from "./95c82e1d0a90e065aac80527ab897b3accc1c5ba.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">Wealth Up</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
        <img alt="" className="absolute h-[147.62%] left-0 max-w-none top-[-23.81%] w-[110.71%]" src={imgIntro} />
      </div>
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="cover 1">
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[22px] text-left text-white">
            <p className="leading-[normal]">Wealth Up is a financial app that lets you invest in car loans, home loans, and startup capital. If you want more options for borrowing Apart from financial institutions, Wealth Up is what you need.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch cursor-pointer flex gap-[10px] items-center relative shrink-0 w-full">
      <div className="bg-[#946e52] flex-[1_0_0] min-w-px relative rounded-[10px]" role="link" tabIndex="0" data-name="Button">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-center text-white whitespace-nowrap">
              <p className="leading-[normal] text-[18px]">View prototype</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[10px]" role="link" tabIndex="0" data-name="Button">
        <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center px-[20px] py-[10px] relative size-full">
            <div className="flex flex-col font-['Kaisei_Decol:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#946e52] text-[18px] text-center whitespace-nowrap" role="link" tabIndex="0">
              <p className="cursor-pointer leading-[normal]">View Figma file</p>
            </div>
          </div>
        </div>
        <div aria-hidden="true" className="absolute border border-[#946e52] border-solid inset-[-0.5px] pointer-events-none rounded-[10.5px]" />
...
export default function WealthUpPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="Wealth Up page">
      <AboutMe />
      <Button />
      <Intro3 />
    </button>
