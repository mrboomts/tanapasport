...
import imgRhiliLandingPageCover1 from "./72e339a087fcb1c9bcde4fe47f1358d29bf8d080.png";
      ...
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[2px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Kaisei_Decol:Bold',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[80px] text-left text-white">
            <p className="leading-[100px]">RHILI (Landing page)</p>
          </div>
        </div>
      </div>
    </div>
...
function Intro1() {
  return (
    <div className="content-stretch flex h-[420px] items-center justify-center overflow-clip relative rounded-[30px] shrink-0 w-[560px]" data-name="Intro">
      ...
      <div className="flex-[1_0_0] h-full min-w-px relative" data-name="RHILI Landing page cover 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRhiliLandingPageCover1} />
      </div>
    </div>
  );
}
        ...
        <div className="content-stretch flex flex-col items-start p-[2px] relative size-full">
          <div className="flex flex-col font-['Kaisei_Decol:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[22px] text-left text-white w-full">
            <p className="leading-[normal]">
              RHILI is a live streaming application that can stream to many social platforms at the same time.
              <br aria-hidden="true" />
              And has an A.I. to detect keywords of selling and buying comments to manage inventory.
            </p>
          </div>
        </div>
      </div>
...
export default function RhiliPage() {
  return (
    <button className="block cursor-pointer relative size-full" data-name="RHILI page">
      <AboutMe />
      <Intro3 />
      <Button />
    </button>
